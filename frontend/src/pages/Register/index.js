        ...
        <div className="register-container">
            <div className="content">
                <section>
                    ...
                    <Link className="link" to="/"><FiArrowLeft size={16} color="#E02041" />Não tenho cadastro</Link>
                </section>
                <form onSubmit={handleRegister}> {/* "onSubmit" dispara a ação assim que o formulario for submetido */}
                    <input
